...
<div class="boite__carrousel">
    <div class="boite__carrousel__bouton">
         <button class="boite__carrousel__svg">
            
            <svg width="24" height="24" 
                  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" color="rgb(255, 0, 0)">
